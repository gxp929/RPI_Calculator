...
translations = {
    "en": {
        ...
        "discount3": "Discount 3 (MYR)",
        "deposit_paid": "Deposit Paid (MYR)",
        "loan_ratio": "Loan Ratio (%)",
        "interest": "Interest Rate (%)",
        "years": "Loan Tenure (Years)",
        "stamp_duty": "Stamp Duty and Other Legal Fees (0.5% of SPA, editable)",
        ...
        "total_cash_required": "Total Cash Required",
...
discount3 = st.number_input(t["discount3"], value=10000.0)
deposit_paid = st.number_input(t["deposit_paid"], value=50000.0)
loan_ratio = st.number_input(t["loan_ratio"], value=90.0)
interest = st.number_input(t["interest"], value=5.0)
years = st.number_input(t["years"], value=25)
stamp_default = 0.005 * spa_price
stamp_duty = st.number_input(t["stamp_duty"], value=stamp_default)
consent = st.number_input(t["consent"], value=1000.0)
legal = st.number_input(t["legal"], value=3000.0)
min_bal = st.number_input(t["min_bal"], value=10000.0)
cushion = st.number_input(t["cushion"], value=10000.0)
renov = st.number_input(t["renov"], value=30000.0)
rate = st.number_input(t["rate"], value=300.0)
